...
export default function TicketsAbiertos({ esJefe }) {
  ...
  return (
    <div className="ta-page">
      <div className="page-header">
        <div className="page-header-left">
          <h1 className="page-title" style={{ marginBottom: 0 }}>
            {esJefe ? 'Tickets Abiertos' : 'Mis Tickets Abiertos'}
          </h1>
          <span className="badge">{total} total</span>
          {!esJefe && <span className="badge">asignados a mí</span>}
        </div>
      ...
      <style>{`
        ...
        .col-label { font-size: var(--fs-lg); font-weight: 600; color: var(--text); flex: 1; }
      `}</style>
    </div>
  )
}
